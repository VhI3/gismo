// GismoImportPlugIn.h : main header file for the GismoImport plug-in.
//

#pragma once

// CGismoImportPlugIn
// See GismoImportPlugIn.cpp for the implementation of this class
//
#include "GismoImportImplementation.h"

class CGismoImportPlugIn : public CRhinoFileImportPlugIn
{
public:
  ...
  // CGismoImportPlugIn destructor. The destructor is called to destroy
  // "thePlugIn" when the plug-in is unloaded. Immediately before the
  // DLL is unloaded, CGismoImportPlugIn::OnUnloadPlugin() is called. Do
...
private:
  ...
  CGismoImportImplementation m_impl;
